...
if decksize == '3' or decksize == '6' or decksize == '10' or decksize == '13':
    ...
    if player == 'person':
        ...
        if decksize == '3':
            ...
            nametwocard = random.randint(0,3)
            ...
            namecard = random.randint(0,6)
            print("Ok", name,"your card is", namecard)
            nametwocard = random.randint(0,6)
            print("Ok", nametwo,"your card is", nametwocard)
            if namecard > nametwocard:
                print(name,"wins!")
            else:
            ...
            namecard = random.randint(0,10)
            print("Ok", name,"your card is", namecard)
            nametwocard = random.randint(0,10)
            print("Ok", nametwo,"your card is", nametwocard)
            if namecard > nametwocard:
                print(name,"wins!")
            else:
            ...
            namecard = random.randint(0,13)
            print("Ok", name,"your card is", namecard)
            nametwocard = random.randint(0,13)
            print("Ok", nametwo,"your card is", nametwocard)
            if namecard > nametwocard:
                print(name,"wins!")
            else:
